...
// P01 (plans/01-domain-and-contracts.md): "Fixtures added by implementation plans must include at
// least one valid and one invalid example for each schema" (contracts/schemas/README.md). This
// proves every schema actually rejects something, not just that it parses.
...
// Every fixtures/ subdirectory must correspond to a real schema (no stale/typo'd directories).
