// Carried over from archive/pre-design-cleanup-2026-09-05:packages/acp/src/classify.ts
// (findings §7); changes: none.
...
/** Minimal JSON-RPC shape classification — method-schema validation lives in validate.ts. */
