// Carried over from archive/pre-design-cleanup-2026-09-05:packages/domain/src/uuid.ts
// (nameBasedUuid, commit archive tag; findings §7 "name-based UUID item identity"); changes:
// none to the algorithm.
 ...
 * same UUID. Projected items derive their identity from stable keys so a rebuild reproduces
 * identical rows and therefore an identical rebuild-equivalence hash.
 */
